<template>
  <div>
      ...
      >
        ...
        <template slot="opt" slot-scope="scope">
          ...
          <el-button
            ...
            icon="el-icon-delete"
            size="mini"
            @click="removeEditById(scope.row.cat_id)"
            >删除</el-button
          >
        </template>
      </tree-table>
    ...
    >
      ...
      >
        <el-form-item label="分类名称：" prop="cat_name">
          <el-input v-model="editCateForm.cat_pid"></el-input>
        </el-form-item>
        <el-form-item label="分类父 ID" prop="cat_pid">
...
<script>
import Pagination from "../assembly/Pagination.vue";
export default {
  components: {
    Pagination,
  },
